import { RemixBrowser } from '/build/_shared/chunk-FM37HHYK.js';
import {
  React,
  __commonJS,
  __toESM,
  ...
  'node_modules/react-dom/cjs/react-dom.development.js': function (exports) {
    ...
    if (true) {
      (function () {
        ...
        let validateProperty$1 = function () {};
        {
          ...
          validateProperty$1 = function (tagName, name, value, eventRegistry) {
            ...
            if (eventRegistry != null) {
              const registrationNameDependencies2 =
                eventRegistry.registrationNameDependencies;
              const possibleRegistrationNames2 = eventRegistry.possibleRegistrationNames;
              if (registrationNameDependencies2.hasOwnProperty(name)) {
                return true;
              }
              const registrationName = possibleRegistrationNames2.hasOwnProperty(
                lowerCasedName
              )
        ...
        const Snapshot = 256;
        const Passive = 512;
        const PassiveUnmountPendingDev = 8192;
        ...
        const ForceUpdateForLegacySuspense = 16384;
        ...
        const eventPriorities = /* @__PURE__ */ new Map();
        ...
        const InputContinuousHydrationLane = 32;
        const InputContinuousLanes = 192;
        const DefaultHydrationLane = 256;
        const DefaultLanes = 3584;
        const TransitionHydrationLane = 4096;
        const TransitionLanes = 4186112;
        const RetryLanes = 62914560;
        const SomeRetryLane = 33554432;
        const SelectiveHydrationLane = 67108864;
        const NonIdleLanes = 134217727;
        const IdleHydrationLane = 134217728;
        const IdleLanes = 805306368;
        ...
        function getNextLanes(root2, wipLanes) {
          ...
          const { expiredLanes } = root2;
          const { suspendedLanes } = root2;
          const { pingedLanes } = root2;
          ...
          const { entangledLanes } = root2;
          if (entangledLanes !== NoLanes) {
            const { entanglements } = root2;
        ...
        function extractEvents$4(
          ...
          const inCapturePhase = (eventSystemFlags & IS_CAPTURE_PHASE) !== 0;
          {
            ...
            const _listeners = accumulateSinglePhaseListeners(
              targetInst,
              reactName,
              nativeEvent.type,
              inCapturePhase,
            ...
            if (_listeners.length > 0) {
              const _event = new SyntheticEventCtor(
                reactName,
                reactEventType,
                null,
                nativeEvent,
        ...
        function checkPropTypes(typeSpecs, values, location, componentName, element) {
          {
            const has2 = Function.call.bind(Object.prototype.hasOwnProperty);
        ...
        const initialTimeMs$1 = Scheduler_now$1();
        const now =
          initialTimeMs$1 < 1e4
            ? Scheduler_now$1
            : function () {
        ...
        const { isArray } = Array;
        const emptyRefsObject = new React2.Component().refs;
        ...
        function callComponentWillReceiveProps(
          ...
          if (instance.state !== oldState) {
            {
              const componentName = getComponentName(workInProgress2.type) || 'Component';
        ...
        function useMutableSource(hook, source, getSnapshot, subscribe) {
          ...
          const _dispatcher$useState = dispatcher.useState(function () {
        ...
        function updateProfiler(current2, workInProgress2, renderLanes2) {
          {
            workInProgress2.flags |= Update;
            const { stateNode } = workInProgress2;
        ...
        function updateHostRoot(current2, workInProgress2, renderLanes2) {
          ...
          if (root2.hydrate && enterHydrationState(workInProgress2)) {
            {
              const { mutableSourceEagerHydrationData } = root2;
        ...
        function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
          ...
          if (current2 === null) {
            ...
            if (typeof nextProps.unstable_expectedLoadTime === 'number') {
              const _fallbackFragment = mountSuspenseFallbackChildren(
                workInProgress2,
                nextPrimaryChildren,
                nextFallbackChildren,
                renderLanes2
          ...
          if (prevState !== null) {
            if (showFallback) {
              ...
              const _fallbackChildFragment = updateSuspenseFallbackChildren(
                current2,
                workInProgress2,
              ...
              const _primaryChildFragment3 = workInProgress2.child;
            ...
            const _primaryChildFragment4 = updateSuspensePrimaryChildren(
              current2,
              workInProgress2,
          ...
          if (showFallback) {
            ...
            const _fallbackChildFragment2 = updateSuspenseFallbackChildren(
              current2,
              workInProgress2,
            ...
            const _primaryChildFragment5 = workInProgress2.child;
            const _prevOffscreenState = current2.child.memoizedState;
          ...
          const _primaryChildFragment6 = updateSuspensePrimaryChildren(
            current2,
            workInProgress2,
        ...
        function beginWork(current2, workInProgress2, renderLanes2) {
          const updateLanes = workInProgress2.lanes;
          {
            ...
            if (
              ...
              switch (workInProgress2.tag) {
                ...
                case SuspenseListComponent: {
                  ...
                  const _hasChildWork = includesSomeLane(
                    renderLanes2,
                    workInProgress2.childLanes
                  );
                  if (didSuspendBefore) {
          ...
          do {
            switch (workInProgress2.tag) {
              case HostRoot: {
                ...
                const _update = createRootErrorUpdate(workInProgress2, _errorInfo, lane);
        ...
        function scheduleUpdateOnFiber(fiber, lane, eventTime) {
          ...
          const root2 = markUpdateLaneFromFiberToRoot(fiber, lane);
          if (root2 === null) {
        ...
        function performConcurrentWorkOnRoot(root2) {
          ...
          let exitStatus = renderRootConcurrent(root2, lanes);
          if (
            includesSomeLane(
        ...
        function completeUnitOfWork(unitOfWork) {
          ...
          do {
            ...
            if ((completedWork.flags & Incomplete) === NoFlags) {
              ...
              const _next = unwindWork(completedWork);
              if (_next !== null) {
        ...
        function flushPassiveEffectsImpl() {
          ...
          let effect = root2.current.firstEffect;
          while (effect !== null) {
        ...
        function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error2) {
          ...
          const eventTime = requestEventTime();
          const root2 = markUpdateLaneFromFiberToRoot(rootFiber, SyncLane);
          if (root2 !== null) {
          ...
          while (fiber !== null) {
            ...
            if (fiber.tag === ClassComponent) {
              ...
              if (
                ...
                enqueueUpdate(fiber, update);
                const eventTime = requestEventTime();
                const root2 = markUpdateLaneFromFiberToRoot(fiber, SyncLane);
                if (root2 !== null) {
                  markRootUpdated(root2, SyncLane, eventTime);
                  ensureRootIsScheduled(root2, eventTime);
                  schedulePendingInteractions(root2, SyncLane);
        ...
        function retryTimedOutBoundary(boundaryFiber, retryLane) {
          ...
          const eventTime = requestEventTime();
          const root2 = markUpdateLaneFromFiberToRoot(boundaryFiber, retryLane);
          if (root2 !== null) {
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
        ...
        function scheduleInteractions(root2, lane, interactions) {
          if (interactions.size > 0) {
            ...
            if (subscriber !== null) {
              const threadID = computeThreadID(root2, lane);
              subscriber.onWorkScheduled(interactions, threadID);
            }
          }
        }
        ...
        function startWorkOnPendingInteractions(root2, lanes) {
          ...
          if (interactions.size > 0) {
            const subscriber = tracing.__subscriberRef.current;
            if (subscriber !== null) {
              const threadID = computeThreadID(root2, lanes);
              try {
                subscriber.onWorkStarted(interactions, threadID);
              } catch (error2) {
        ...
        function finishPendingInteractions(root2, committedLanes) {
          const remainingLanesAfterCommit = root2.pendingLanes;
          let subscriber;
          try {
            subscriber = tracing.__subscriberRef.current;
            if (subscriber !== null && root2.memoizedInteractions.size > 0) {
              const threadID = computeThreadID(root2, committedLanes);
        ...
        function createFiberRoot(containerInfo, tag, hydrate3, hydrationCallbacks) {
          const root2 = new FiberRootNode(containerInfo, tag, hydrate3);
        ...
        function createRootImpl(container, tag, options2) {
          const hydrate3 = options2 != null && options2.hydrate === true;
          ...
          const mutableSources =
            ...
            null;
          const root2 = createContainer(container, tag, hydrate3);
